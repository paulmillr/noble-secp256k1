...
describe("secp256k1", () => {
  ...
  it("should create right signature for TEST VECTOR 1", () => {
    ...
    const privateKey = "735c923b14192f9bade94d38828b4d2a5b617691aad9fcf7ced6bffddc9c7e3b";
  ...
  it("should create right signature for TEST VECTOR 2", () => {
    const k = 455128135n;
    const privateKey = "3e43d1f3146eb9247da8fc8609f86a34e1bb1924ac4ebca9aa312dee28e33125";
  ...
  it("should create right signature for TEST VECTOR 3", () => {
    const k = 9379992n;
    const privateKey = "266829a25ea473c632806128eb8ff0ef1fc4382e45a0be8395fffce5f82acefa";
  ...
  it("should create right signature for TEST VECTOR 4", () => {
    const k = 0xdeadbeafn;
    const privateKey = "adee7cb82989f68e1df503445252d269dd432879d80dc63595b9a1a7577e217e";
    const publicKey = secp256k1.getPublicKey(privateKey, true);
