...
```typescript
function sign(hash: Uint8Array, privateKey: Uint8Array, opts?: Options): Promise<Uint8Array>;
function sign(hash: string, privateKey: string, opts?: Options): Promise<string>;
function sign(hash: Uint8Array, privateKey: Uint8Array, opts?: Options): Promise<[Uint8Array | string, number]>;
